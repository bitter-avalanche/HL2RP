...
function THEME:CreateFonts()
	surface.CreateFont("hl2rp2_plain_Large3D2D", {
	...
	surface.CreateFont("hl2rp2_plain_IntroTextSmall", {
	...
	surface.CreateFont("hl2rp2_plain_IntroTextTiny", {
	...
	surface.CreateFont("hl2rp2_plain_CinematicText", {
		size = Clockwork.kernel:FontScreenScale(19),
		weight = 400, 
		antialias = true,
		font = FONT_USED
	});

	surface.CreateFont("hl2rp2_plain_IntroTextBig", {
		size = Clockwork.kernel:FontScreenScale(21),
		weight = 400, 
		antialias = true,
		font = FONT_USED
	});

	surface.CreateFont("hl2rp2_plain_TargetIDText", {
	...
	surface.CreateFont("hl2rp2_plain_SmallBarText", {
		size = Clockwork.kernel:FontScreenScale(10),
		weight = 400, 
		antialias = true,
		font = FONT_USED
	...
	surface.CreateFont("hl2rp2_plain_MenuTextHuge", {
	...
	surface.CreateFont("hl2rp2_plain_MenuTextBig", {
		size = Clockwork.kernel:FontScreenScale(19),
		weight = 400, 
		antialias = true,
		font = FONT_USED
	...
	surface.CreateFont("hl2rp2_plain_PlayerInfoText", {
		size = Clockwork.kernel:FontScreenScale(10),
		weight = 400, 
		antialias = true,
		font = FONT_USED
	...
	surface.CreateFont("hl2rp2_plain_MainText", {
	...
	surface.CreateFont("hl2rp2_plain_BarText", {
		size = Clockwork.kernel:FontScreenScale(10),
		weight = 400, 
		antialias = true,
		font = FONT_USED
	...
	surface.CreateFont("hl2rp2_plain_BarTextAuto", {
		size = Clockwork.kernel:FontScreenScale(8),
		weight = 400, 
		antialias = true,
		font = "Arial"
...
function THEME:Initialize()
	Clockwork.option:SetFont("bar_text", "hl2rp2_plain_BarText");
	Clockwork.option:SetFont("auto_bar_text", "hl2rp2_plain_BarTextAuto");
	Clockwork.option:SetFont("main_text", "hl2rp2_plain_MainText");
	Clockwork.option:SetFont("hints_text", "hl2rp2_plain_IntroTextTiny");
	Clockwork.option:SetFont("large_3d_2d", "hl2rp2_plain_Large3D2D");
	Clockwork.option:SetFont("target_id_text", "hl2rp2_plain_TargetIDText");
	Clockwork.option:SetFont("cinematic_text", "hl2rp2_plain_CinematicText");
	Clockwork.option:SetFont("date_time_text", "hl2rp2_plain_IntroTextSmall");
	Clockwork.option:SetFont("menu_text_big", "hl2rp2_plain_MenuTextBig");
	Clockwork.option:SetFont("menu_text_huge", "hl2rp2_plain_MenuTextHuge");
	Clockwork.option:SetFont("menu_text_tiny", "hl2rp2_plain_IntroTextTiny");
	Clockwork.option:SetFont("intro_text_big", "hl2rp2_plain_IntroTextBig");
	Clockwork.option:SetFont("menu_text_small", "hl2rp2_plain_IntroTextSmall");
	Clockwork.option:SetFont("intro_text_tiny", "hl2rp2_plain_IntroTextTiny");
	Clockwork.option:SetFont("intro_text_small", "hl2rp2_plain_IntroTextSmall");
	Clockwork.option:SetFont("player_info_text", "hl2rp2_plain_PlayerInfoText");
	...
	SMALL_BAR_BG = Clockwork.render:AddSlice9("Small", "hl2rp2/themes/plain/transparent", 8);
	SMALL_BAR_FG = Clockwork.render:AddSlice9("Small", "hl2rp2/themes/plain/small", 8);
	INFOTEXT_SLICED = Clockwork.render:AddSlice9("Large", "hl2rp2/themes/plain/large", 32);
	MENU_ITEM_SLICED = Clockwork.render:AddSlice9("Small", "hl2rp2/themes/plain/small", 8);
	SLICED_SMALL_TINT = Clockwork.render:AddSlice9("Small", "hl2rp2/themes/plain/small", 8);
	SLICED_INFO_MENU_INSIDE = Clockwork.render:AddSlice9("Small", "hl2rp2/themes/plain/small", 8);
	SLICED_COLUMNSHEET_BUTTON = Clockwork.render:AddSlice9("Transparent", "hl2rp2/themes/plain/transparent", 24);
	PANEL_LIST_SLICED = Clockwork.render:AddSlice9("Transparent", "hl2rp2/themes/plain/transparent", 24);
	DERMA_SLICED_BG = Clockwork.render:AddSlice9("Transparent", "hl2rp2/themes/plain/transparent", 24);
	SLICED_LARGE_DEFAULT = Clockwork.render:AddSlice9("Large", "hl2rp2/themes/plain/large", 32);
	SLICED_PROGRESS_BAR = Clockwork.render:AddSlice9("Large", "hl2rp2/themes/plain/large", 32);
	SLICED_PLAYER_INFO = Clockwork.render:AddSlice9("Large", "hl2rp2/themes/plain/large", 32);
	CUSTOM_BUSINESS_ITEM_BG = Clockwork.render:AddSlice9("SmallDark", "hl2rp2/themes/plain/small_dark", 6);
	SLICED_INFO_MENU_BG = Clockwork.render:AddSlice9("Transparent", "hl2rp2/themes/plain/transparent", 24);
