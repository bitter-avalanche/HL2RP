...
Clockwork.hint:AddHumanHint("HintCurfew", "HintHintCurfewDesc");
...
Clockwork.hint:AddHumanHint("HintRations", "HintHintRationsDesc");
Clockwork.hint:AddHumanHint("HintCombine", "Don't mess with the HintCombine, they took over Earth in 7 hours.");
Clockwork.hint:AddHumanHint("HintJumping", "Bunny hopping is uncivilized, and the HintCombine will remind you with their stunsticks.");
Clockwork.hint:AddHumanHint("HintPunching", "HintPunchingDesc");
Clockwork.hint:AddHumanHint("HintCompliance", "Obey the HintCombine, you'll be glad that you did.");
Clockwork.hint:AddHumanHint("HintHintCombineRaids", "When the HintCombine come knocking, get your ass on the floor.");
Clockwork.hint:AddHumanHint("HintRequestDevice", "HintRequestDeviceDesc");
Clockwork.hint:AddHumanHint("HintCivilProtection", "HintCivilProtection, protecting civilized society, not you.");

Clockwork.hint:Add("HintAdmins", "HintAdminsDesc");
Clockwork.hint:Add("HintAction", "HintHintActionDesc");
...
Clockwork.hint:Add("HintMetagaming", "HintHintMetagamingDesc");
