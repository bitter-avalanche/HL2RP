...
ITEM.uniqueID = "normal_ration";
ITEM.model = "models/weapons/w_packatc.mdl";
ITEM.weight = 2;
ITEM.useText = "Open";
ITEM.description = "A normal grade ration unit, usually issued to Citizens.";
...
function ITEM:OnUse(player, itemEntity)
	...
	elseif (player:GetFaction() == FACTION_ADMIN) then
		...
		player:GiveItem(Clockwork.item:CreateInstance("normal_rationbox"), true);
		player:GiveItem(Clockwork.item:CreateInstance("light_tokens"), true);
